...
Interactively install server." t nil)

(autoload 'copilot-uninstall-server "copilot" "\
Delete a Copilot server from `copilot-install-dir'." t nil)

(autoload 'copilot-reinstall-server "copilot" "\
Interactively re-install server." t nil)
...
;;;***

;;;### (autoloads nil "copilot-balancer" "copilot-balancer.el" (0
;;;;;;  0 0 0))
